<template>
  <section>
       	<h3>Una NIÑA CON AFTAS A REPETICION</h3>
      	<img src="~/assets/images/pages/homeopatia_di_blasi_aftas.jpg" alt="Imagen">
	    <p>V.G, de 12 años de edad es traída  a mi consulta por su madre ya que sufre aftas repetidamente desde que era muy  pequeñita (la madre dice que desde bebe ya sufría de aftas muy dolorosas).
	    </p>
		<p>
