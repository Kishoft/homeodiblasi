<template>
  <section>
      <h3>Un joven Esquizofrénico</h3>

	    <p>Agustín, un joven de 13 años, es acompañado a la consulta por su madre por presentar desde hace ya varios años un cuadro compatible con esquizofrenia, enfermedad obsesiva compulsiva y déficit de atención. Refiere escuchar voces (a veces es la suya propia) que lo amenazan con la muerte de sus padres, y lo desconcentran cuando está realizando sus actividades.
