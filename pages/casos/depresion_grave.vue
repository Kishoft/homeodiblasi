<template>
    <section>
        <h3>Una PACIENTE CON DEPRESION GRAVE</h3>
      	<img src="~/assets/images/pages/homeopatia_di_blasi_depresion_grave.jpg" alt="Imagen">
	      <p>La Sra. Mónica G. de 45 años de edad se presenta a mi consultorio el 22 de noviembre  del 2009 acompañada por su madre (con quien vivía), y quien se encargó de  relatarme prácticamente todo el cuadro depresivo que padecía su hija hacía ya  varios años.
	      </p>
		    <p>
